...
unset($__errorArgs, $__bag); ?>" id="nama" name="nama" value="" placeholder="Nama....">
                          </div>
                          <div class="form-group">
 ...
 <script>
  ...
  function isi_table(){  
    ...
    function tambah(){
        $('#simpan').text('Simpan')          
            $.ajax({
              url : "<?php echo e(route('crudAjax_tambah')); ?>",
              type : "POST",
              data : {
                nama : $('#nama').val(),
                alamat : $('#alamat').val(),
      ...
      $(document).on('click', '.update', function(){  
            ...
            $.ajax({
              url : "<?php echo e(route('crudAjax_show')); ?>",
              type : 'POST',
              data : {
                id : id,
                "_token" : "<?php echo e(csrf_token()); ?>"
          ...
          function update(){        
            $.ajax({
              url : "<?php echo e(route('crudAjax_update')); ?>",
              type : "POST",
              data : {
                id : $('#id').val(),
                nama : $('#nama').val(),
          ...
          $(document).on('click', '.destroy', function(){
            Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        let id = $(this).attr('id')                 
                        $.ajax({
                          url : "<?php echo e(route('crudAjax_destroy')); ?>",
                          type : 'POST',
                          data : {
                            id : id,
                            "_token" : "<?php echo e(csrf_token()); ?>"
...
<?php echo $__env->make('dashboard/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO 5\Downloads\Compressed\laravel-9-simple-templates-main\laravel-9-simple-templates-main\resources\views/dashboard/crudAjax.blade.php ENDPATH**/ ?>