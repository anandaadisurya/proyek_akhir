...
<body class="hold-transition register-page">
    ...
    <div class="card card-outline card-primary register-box">
        <div class="card-header text-center register-box">
            <a href="#" class="h1"><b>KRDN</b> PHONE</a>
        </div>
        <div class="card">
...
</html><?php /**PATH C:\Users\ACER NITRO 5\proyek_akhir\resources\views/auth/register.blade.php ENDPATH**/ ?>