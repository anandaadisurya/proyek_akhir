...
unset($__errorArgs, $__bag); ?>" id="nama" name="nama" value="" placeholder="isi nama kamu dong..">
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="telepon" name="telepon" value="" placeholder="telepon....">
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="alamat" name="alamat" value="" placeholder="Alamat...">
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="telepon" name="telepon" value=" <?php echo e($item->telepon); ?>">
                                  </div>
                                  <div class="form-group">
                                    <label for="nama">Alamat</label>
                                    <input type="text" class="form-control rounded-0 <?php $__errorArgs = ['alamat'];
...
unset($__errorArgs, $__bag); ?>" id="alamat" name="alamat" value=" <?php echo e($item->alamat); ?>">
                                  </div>
                                  <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO 5\Downloads\Compressed\laravel-9-simple-templates-main\laravel-9-simple-templates-main\resources\views/dashboard/crud.blade.php ENDPATH**/ ?>