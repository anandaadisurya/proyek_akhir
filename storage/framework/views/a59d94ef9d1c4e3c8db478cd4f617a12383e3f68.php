...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="" placeholder="isi nama admin" required>
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="" placeholder="isi email admin" required>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="password" name="password" value="" placeholder="isi pasword admin" required>
                          </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO 5\proyek_akhir\resources\views/dashboard/daftaruser.blade.php ENDPATH**/ ?>