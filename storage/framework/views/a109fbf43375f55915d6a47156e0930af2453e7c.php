...
unset($__errorArgs, $__bag); ?>" id="nama_produk" name="nama_produk" value="" placeholder="isi nama produk" required>
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="harga" name="harga" value="" placeholder="isi daftar harga" required>
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" value="" placeholder="status" required>
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="gambar" name="gambar" value="" placeholder="gambar produk" required>
                          </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>" id="nama_produk" name="nama_produk" value=" <?php echo e($item->nama_produk); ?>" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="nama">Harga Per Jam</label>
                                    <input type="text" class="form-control rounded-0 <?php $__errorArgs = ['harga'];
...
unset($__errorArgs, $__bag); ?>" id="harga" name="harga" value=" <?php echo e($item->harga); ?>" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="nama">Status</label>
                                    <input type="text" class="form-control rounded-0 <?php $__errorArgs = ['status'];
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" value=" <?php echo e($item->status); ?>" required>
                                  </div>
                                  <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO 5\proyek_akhir\resources\views/dashboard/produk.blade.php ENDPATH**/ ?>