...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('logout')); ?>" role="button" title="logout">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="brand-link">
      ...
      <span class="brand-text font-weight-light">KRDN PHONE </span>
    </a>
...
<?php /**PATH C:\Users\ACER NITRO 5\Downloads\Compressed\laravel-9-simple-templates-main\laravel-9-simple-templates-main\resources\views/dashboard/master.blade.php ENDPATH**/ ?>