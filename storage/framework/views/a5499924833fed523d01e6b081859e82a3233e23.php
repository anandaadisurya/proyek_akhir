          ...
          <div class="card">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <!-- End Button Tambah -->
                <!-- Modal Tambah -->
                <form method="POST" action="<?php echo e(route('crud_tambah')); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" id="nama" name="nama" value="" placeholder="Isi nama Penyewa" required>
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="" placeholder="Isi Email Penyewa" required>
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="telepon" name="telepon" value="" placeholder="Isi Nomor Hp Penyewa" required>
                          </div>
                          <div class="form-group">
                            <label for="nama">Alamat</label>
                            <input type="text" class="form-control rounded-0 <?php $__errorArgs = ['alamat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="alamat" name="alamat" value="" placeholder="Isi Alamat Penyewa" required>
                          </div>
                          <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="gambar" name="gambar" value="" placeholder="Isi Foto Penyewa" required >
                          </div>
                        </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $dummy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <!-- Modal Hapus -->
                        <form method="POST" action="<?php echo e(route('crud_hapus', ['id' => $item->id])); ?>" enctype="multipart/form-data">
                          <?php echo e(csrf_field()); ?>
                          ...
                          <div class="modal fade" id="modalHapus-<?php echo e($item->id); ?>">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Hapus Data : <?php echo e($item->nama); ?></h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">
                                  <p>Anda yakin akan menghapus data : <?php echo e($item->nama); ?></p>
                                </div>
                                <div class="modal-footer">
...
unset($__errorArgs, $__bag); ?>" id="nama" name="nama" value=" <?php echo e($item->nama); ?>" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="nama">Email</label>
                                    <input type="email" class="form-control rounded-0 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value=" <?php echo e($item->email); ?>" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="nama">telepon</label>
                                    <input type="tel" class="form-control rounded-0 <?php $__errorArgs = ['telepon'];
...
unset($__errorArgs, $__bag); ?>" id="telepon" name="telepon" value=" <?php echo e($item->telepon); ?>" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="nama">Alamat</label>
                                    <input type="text" class="form-control rounded-0 <?php $__errorArgs = ['alamat'];
...
unset($__errorArgs, $__bag); ?>" id="alamat" name="alamat" value=" <?php echo e($item->alamat); ?>" required>
                                  </div>
                                  <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO 5\proyek_akhir\resources\views/dashboard/crud.blade.php ENDPATH**/ ?>