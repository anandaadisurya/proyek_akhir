...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ route('login') }}" class="h1"><b>KRDN</b> PHONE</a>
    </div>
    <div class="card-body">
      ...
      <form action="{{ route('auth') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control @error('email') is-invalid  @enderror" name="name" value="{{ old('name') }}" placeholder="Username">
